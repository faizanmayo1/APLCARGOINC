...
import { ApprovalInbox } from "@/features/workflows/ApprovalInbox";
import { RunHistory } from "@/features/workflows/RunHistory";

import { WORKFLOWS, APPROVAL_INBOX, RUN_HISTORY, type Workflow } from "@/mocks/seed/workflows";
  ...
  return (
    <div className="px-6 lg:px-8 py-6 lg:py-8 max-w-[1440px] mx-auto space-y-6 reveal-stack">
      <PageHeader
        ...
        subtitle="Automations that turn AI predictions into action — fully auto, or pause for human approval where it matters."
        actions={
          <>
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <StatTile
          ...
          note="ranked by margin-at-stake"
          tone="warning"
        />
        <StatTile
          label="Saved · today"
          value="$5.4K"
          note="auto + approved actions"
          tone="success"
        />
      </section>
