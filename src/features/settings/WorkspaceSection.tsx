  ...
  return (
    <div className="space-y-5">
      <SettingsSection
        ...
        description="Used in shipper-facing emails, invoices, and the FreightIQ login screen."
      ...
      >
        <div className="px-5 pb-5 grid grid-cols-1 lg:grid-cols-[120px_1fr] gap-5 items-start">
          ...
          <div className="space-y-2">
            ...
            <button className="relative h-24 w-24 rounded-xl bg-gradient-to-br from-brand-700 to-accent-700 grid place-items-center text-ink-invert shadow-elev-1 group">
              <span className="font-display text-[32px] font-semibold leading-none">A</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field label="Company name">
              <Input defaultValue="APL Cargo Inc." />
            </Field>
            <Field label="Display name" hint="Shown in the sidebar.">
              <Input defaultValue="APL Cargo" />
            </Field>
            <Field label="Headquarters">
              <Input defaultValue="Atlanta, GA · 1450 Lakes Pkwy" />
            </Field>
            <Field label="DOT number">
              <Input defaultValue="DOT-2240148" />
            </Field>
            <Field label="MC number">
              <Input defaultValue="MC-770115" />
            </Field>
            <Field label="Time zone" hint="Used for ETA windows and reporting.">
              <Input defaultValue="America / New York (ET)" />
            </Field>
          </div>
        </div>
      </SettingsSection>
