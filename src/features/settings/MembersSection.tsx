...
import { MEMBERS } from "@/mocks/seed/settings";
  ...
  return (
    <div className="space-y-5">
      <SettingsSection
        ...
        description="FreightIQ uses role-based access. Adjust permissions per role under Roles → Customize."
        actions={
          <>
      ...
      <SettingsSection caption="Roles" title="Permission summary">
        <div className="px-5 pb-5 grid grid-cols-1 md:grid-cols-3 gap-3">
          <RoleTile name="Owner" perms={["Full access", "Billing", "Workspace settings"]} />
          <RoleTile name="Admin" perms={["All operations", "Members", "Integrations"]} />
          <RoleTile name="Dispatcher" perms={["Loads", "Drivers", "Exceptions"]} />
          <RoleTile name="Fleet Mgr" perms={["Fleet", "Maintenance", "Drivers"]} />
