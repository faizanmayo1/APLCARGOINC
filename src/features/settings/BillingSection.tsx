...
export function BillingSection() {
  return (
    <div className="space-y-5">
      <SettingsSection caption="Plan" title="FreightIQ Enterprise">
          ...
          <div className="ai-edge rounded-xl bg-surface p-5 grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-5 items-start">
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="text-[11px] text-ink-muted">Renews Apr 27, 2027</span>
              </div>
              <h3 className="mt-2 font-display text-h2 text-ink-primary tracking-tight leading-tight">
                $48,000 / year
              </h3>
              <p className="mt-1 text-body text-ink-muted">
                Up to 200 active units · 50 seats · unlimited workflows · 7-yr audit retention.
              </p>
              <ul className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1.5">
                {[
                  "All 6 AI capabilities live",
                  "Dedicated success engineer",
                  "SOC 2 Type II reports",
                  "SAML SSO + SCIM",
                  "Priority TMS / EDI integrations",
                  "99.95% uptime SLA",
                ].map((f) => (
      ...
      <SettingsSection caption="Usage · this billing period" title="142 of 200 units">
        <div className="px-5 pb-5 grid grid-cols-1 sm:grid-cols-3 gap-3">
          <UsageBar label="Active units" used={142} total={200} suffix=" units" />
          <UsageBar label="Active seats" used={6} total={50} suffix=" seats" />
