...
const SUGGESTIONS = [
  "What's our worst lane this month and why?",
  "Show drivers near HOS exhaustion",
  ...
  return (
    <div className="ai-edge group rounded-xl bg-surface p-4 transition-all">
      <div className="flex items-center gap-3">
        ...
        <input
          type="text"
          placeholder="Ask FreightIQ anything — “What changed in our cost-per-mile this week?”"
